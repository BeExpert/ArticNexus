...
FROM app, (VALUES
    ...
    ('recordatorios.ver',        'Ver recordatorios',         'Puede ver recordatorios inteligentes de vacunas y desparasitaciones'),
    ('recordatorios.crear',      'Crear recordatorios',       'Puede generar tickets de recordatorio para clientes'),
    -- ── Administración ──────────────────────────────────────────────
    ('admin.usuarios',           'Administrar usuarios',      'Puede gestionar usuarios de la aplicación'),
    -- ── Portal de cliente (rol "Cliente") ───────────────────────────
    ('portal.ver',               'Acceso al portal',          'Acceso base al portal de cliente'),
    ('portal.mascotas.ver',      'Ver mis mascotas',          'Ver perfil y datos clínicos de sus mascotas'),
    ('portal.tickets.ver',       'Ver mis tickets',           'Ver tickets de soporte creados por el cliente'),
    ('portal.tickets.crear',     'Crear tickets',             'Crear nuevos tickets de soporte')
